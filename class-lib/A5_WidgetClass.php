...
class A5_Widget extends WP_Widget {
	...
	function select_heading ($instance, $alignment = false) {
		...
		if ($alignment == true) :
			...
			$alignment = array (array('left', __('Left', 'advanced-cc')), array('right', __('Right', 'advanced-cc')), array('center', __('Center', 'advanced-cc')), array('justify', __('Justify', 'advanced-cc')));
			
			a5_select($base_id.'halign', $base_name.'[halign]', $alignment, $instance['halign'], __('How do you want to align the Post Title?', 'advanced-cc'), false, array('space' => true));
